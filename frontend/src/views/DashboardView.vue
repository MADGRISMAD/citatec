<template>
  <div class="min-h-screen bg-gray-50">
    <header class="bg-white shadow">
      <div
        class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:items-center lg:justify-between">
        <!-- Logo y Título -->
        ...
        <nav class="flex space-x-4">
          <button @click="$router.push('/reporte')"
          ...
          <button @click="$router.push('/tramites')"
            class="px-4 py-2 text-sm font-medium rounded-md text-white bg-[#1B396A] hover:bg-[#294d8e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1B396A]">
            Trámites
          </button>
        </nav>

        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input v-model.number="newCapacityHours" type="number" min="0" id="hours"
            ...
            <div>
              ...
              <input v-model.number="newCapacityMinutes" type="number" min="0" max="59" id="minutes"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-[#1B396A] focus:border-[#1B396A]" />
            </div>
          </div>
          <!-- Botones -->
      ...
      <div v-if="tickets.length" class="px-4 py-6 sm:px-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div v-for="ticket in tickets" :key="ticket.id"
            ...
            <!-- Badge de categoría -->
            <span class="absolute top-4 right-4 inline-block px-3 py-1 rounded-full text-sm font-medium"
